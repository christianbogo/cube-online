...
exports.AVERAGEABLE_EVENT_IDS = exports.SUPPORTED_EVENT_IDS = exports.SCRAMBLE_TYPES = void 0;
exports.SCRAMBLE_TYPES = [
    ...
    { label: 'FTO', value: 'fto', isAverageable: true },
...
exports.SUPPORTED_EVENT_IDS = exports.SCRAMBLE_TYPES.map(e => e.value);
exports.AVERAGEABLE_EVENT_IDS = exports.SCRAMBLE_TYPES.filter(e => e.isAverageable).map(e => e.value);

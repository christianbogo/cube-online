...
exports.getOldestSolveNumber = exports.getLogsBottomStats = exports.getLogsSidebarData = exports.getPaginatedSolves = void 0;
 ...
 */
exports.getOldestSolveNumber = functions.runWith({ timeoutSeconds: 30, memory: '512MB' }).https.onCall(async (data, context) => {
    var _a;
    if (!context.auth)
        throw new functions.https.HttpsError('unauthenticated', 'Must be logged in');
    const userId = context.auth.uid;
    const scrambleType = (data === null || data === void 0 ? void 0 : data.scrambleType) || '333';
    const solveId = data === null || data === void 0 ? void 0 : data.solveId;
    let solveDate = data === null || data === void 0 ? void 0 : data.solveDate;
    ...
    if (!solveDate && solveId) {
        ...
        if (docSnap.exists) {
            solveDate = (_a = docSnap.data()) === null || _a === void 0 ? void 0 : _a.date;
        }
    }
    if (!solveDate) {

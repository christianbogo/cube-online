...
export interface WcaBadgeProps {
...
export function WcaBadge({
    ...
    const titleText = title !== undefined ? title : (user?.username ? `${user.username} (WCA Verified)` : 'Verified WCA profile');
